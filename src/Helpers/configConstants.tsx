...
const IMAGE_URL =
  process.env.REACT_APP_IMAGE_URL + ":" + process.env.REACT_APP_SERVER_PORT;
const SERVER_URL =
...
const PUBLIC_URL =
  process.env.REACT_APP_PUBLIC_URL + ":" + process.env.REACT_APP_PUBLIC_PORT;
const PUBLIC_URL_NOPORT = process.env.REACT_APP_PUBLIC_URL;
const FEE_PERCENTAGE: number = Number(process.env.REACT_APP_FEE_PERCENTAGE);
...
var GENRE_MAP: { [key: string]: string } = {};
...
const TH_DEFAULT_DEALS: {
  ...
  default: {
    ...
    description: (
      <span>
        Artists will not receive payment for this performance, and will not have
        to pay a production fee.
      </span>
    ),
    options: [],
  },
  guarantee: {
    ...
    description: (
      <span>
        Artists will be paid a specific dollar amount for their performance.
      </span>
    ),
  ...
  ticket_split: {
    ...
    label: "Ticket Split",
    description: (
      <span>Artists will split a specified amount of ticket sales.</span>
    ),
