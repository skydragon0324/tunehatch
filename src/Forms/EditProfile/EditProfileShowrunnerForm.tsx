...
export default function EditProfileShowrunnerForm() {
    ...
    <Form
      ...
      formMap={[
        [
          {
            fieldType: "title",
            defaultValue: "Time To Run Shows",
          ...
          },
          {
            ...
            defaultValue:
              ...
              "Putting on great shows just got a lot easier.",
            className: "w-full flex-col text-center text-md mt-2",
          },
          {
            fieldType: "title",
          ...
          },
          {
            ...
            placeholder: "Enable Showrunner Features",
            fieldType: "toggleSlider",
            required: false,
            defaultValue: user.type.showrunner.enabled,
          },
        ],
      ]}
    />
