...
export default function TOS() {
  useEffect(() => {
    renderPageTitle("Terms of Service");
  }, []);
  return (
    <>
      <div className="tos std-pad" data-custom-class="body">
        <div style={{ textAlign: "left", lineHeight: 1 }}>
          ...
          >
            ...
            >
              ...
              <div className="MsoNormal" style={{ lineHeight: "22.5px" }}>
                <div className="MsoNormal" style={{ lineHeight: "150%" }}>
                  ...
                  >
                    <strong>
                      ...
                      >
                        <div id="bdt" className="block-component" />
                        <div id="bdt" className="question">
                          TERMS AND CONDITIONS
                        </div>
                        <div id="bdt" className="statement-end-if-in-editor" />
                      </span>
                    </strong>
                  </div>
                  <div
              ...
              <div style={{ lineHeight: "1.5", textAlign: "left" }}>
                <span style={{ fontSize: 15 }}>
                  <a data-custom-class="link" href="#userreg">
                    <span style={{ color: "rgb(89, 89, 89)" }}>
                      <div id="bdt" data-type="conditional-block">
                        <div
                          id="bdt"
              ...
              <div style={{ lineHeight: "1.5", textAlign: "left" }}>
                ...
                <div id="bdt" className="block-container if" data-type="if">
                  <div
                    id="bdt"
                    className="statement-end-if-in-editor"
                    data-type="close"
              ...
              <div style={{ lineHeight: "1.5", textAlign: "left" }}>
                <span style={{ fontSize: 15 }}>
                  {/* <a data-custom-class="link" href="#terms" aria-label="terms" /> */}
            ...
            >
              ...
              >
                ...
                >
                  <a
                    ...
                    href="http://www.tunehatch.com"
                    target="_blank"
                    data-custom-class="link"
                  >
                    http://www.tunehatch.com
                  </a>
                </div>{" "}
              ...
              >
                ...
                >
                  ...
                  <div id="bdt" className="else-block" />
                </span>
              </span>
              <div id="bdt" className="statement-end-if-in-editor" />
              <div id="bdt" className="block-component" /> You agree that by
          ...
          >
            ...
            >
              ...
              >
                ...
                of Use <div id="bdt" className="block-component" />
                at any time and for any reason
                <div id="bdt" className="statement-end-if-in-editor" />. We will
          ...
          >
            ...
            <div className="flex-col MsoNormal" style={{ lineHeight: "1.5" }}>
              <span
                style={{
                  fontSize: "11.0pt",
                  lineHeight: "115%",
          ...
          >
            ...
            <div className="flex-col MsoNormal" style={{ lineHeight: 1 }}>
              <br />
            </div>
          </div>
          <div
          ...
          >
            ...
            <div className="flex-col MsoNormal" style={{ lineHeight: "115%" }}>
                ...
                <ul>
                  ...
                  >
                    <span style={{ fontSize: 15 }}>
                      ...
                      <div id="bdt" className="statement-end-if-in-editor" />
                      <div id="bdt" className="forloop-component" />
                    </span>
                  </li>
                </ul>
                <div
                ...
                <div id="bdt" data-type="body">
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        <a
                          href="http://www.tunehatch.com/privacy"
                          target="_blank"
                          data-custom-class="link" rel="noreferrer"
                        >
                          http://www.tunehatch.com/privacy
                        </a>
                      </div>
                    </b>
                    <span
                    ...
                    >
                      ...
                      >
                        ...
                        >
                          ...
                          >
                            <div id="bdt" className="block-component" /> state
                            and federal courts
                            <div
                              id="bdt"
                              className="statement-end-if-in-editor"
                            ...
                            <strong>
                              ...
                              >
                                <div
                                  ...
                                  data-type="question"
                                >
                                  <strong>info@tunehatch.com</strong>
                                </div>
                              </span>
                            </strong>
                          </strong>
